--
-- File generated with SQLiteStudio v3.3.3 on Mon Jan 23 17:03:11 2023
--
...
CREATE TABLE ads_evaluation (
    ...
    _customer_business         VARCHAR (10)  NOT NULL,
    _customer_financial_status VARCHAR (10)  NOT NULL,
    _access_to_funds           VARCHAR (10)  NOT NULL,
    _decisive_event            VARCHAR (10)  NOT NULL,
    ...
    remarks                    VARCHAR (100),
    _final_applicability       VARCHAR (10)  NOT NULL,
    PRIMARY KEY (
        _pk
    ),
    FOREIGN KEY (
...
-- Index: ix_ads_evaluation__customer_financial_status
DROP INDEX IF EXISTS ix_ads_evaluation__customer_financial_status;

CREATE INDEX ix_ads_evaluation__customer_financial_status ON ads_evaluation (
    _customer_financial_status
);
